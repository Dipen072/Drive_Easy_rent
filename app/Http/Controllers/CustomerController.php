...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'profile_picture.image' => 'Profile picture must be an image file (jpeg, png, webp).',
            'profile_picture.max'   => 'Profile picture size cannot exceed 5MB.',
            'dl_file.max'           => 'Driving License file size cannot exceed 5MB.',
            'alt_id_file.max'       => 'Alternate ID file size cannot exceed 5MB.',
        ]);
